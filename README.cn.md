...
- [x] 列出玩家、基地及其帕鲁，并按基地分组打工帕鲁；无法匹配基地的工作帕鲁显示在“未分配”入口中
- [x] 显示基地名称、所属工会、基地等级、工作帕鲁数量和地图坐标
- [x] 编辑各工会已有研究所的研究科技树；解锁项目时级联解锁前置研究，取消项目时级联取消后续研究，并支持一键解锁全部研究
  - 公会研究编辑仅适用于已经存在研究所数据的工会；编辑器不会为缺少研究所数据的工会创建该数据
- [x] 修改玩家等级
- [x] 修改玩家昵称
- [x] 解锁科技
- [x] 查看帕鲁数据
