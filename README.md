...
> [!NOTE]
> This repository is a fork of [KrisCris/Palworld-Pal-Editor](https://github.com/KrisCris/Palworld-Pal-Editor) that keeps the upstream code and history as compatible as possible while adding:
>
> - **Palworld 1.0 data fixes** — synchronized Pal, skill, technology, experience, and passive-skill data
> - **Guild Research editing** — inspect and edit each guild's existing Lab research tree
> - **Base-aware Pal rosters** — group workers by base, show unassigned workers, and display base information
> - **Pal editing and roster improvements** — IV randomization, favorite and trust-rank markers, EXP diagnostics, and additional sorting options
>
> **Disclaimer:** Every fork-specific modification was generated by large language models (LLMs). The maintainer knows absolutely nothing about game-save editing; the LLMs did all the work, meow~
...
> [!NOTE]
> **Game compatibility:** This fork supports Palworld 1.0 saves and the corresponding Pal, passive-skill, active-skill, technology, experience, Guild Research, and base data.
...
> [!NOTE]
> Item inventory editing is not supported yet. References to inventories below describe Pal containers only.
>
...
- [x] Add Pal to the selected player
- [x] Delete Pal
- [x] Duplicate Pal
- [x] Change Pal Gender
